...
@OnlyIn(Dist.CLIENT)
public class OveriteElytraArmorStandLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation WINGS_LOCATION = new ResourceLocation("textures/entity/overrite_elytra.png");
    private final ElytraModel<T> elytraModel;

    public OveriteElytraArmorStandLayer(RenderLayerParent<T, M>  armorStandRender, EntityModelSet p_174494_) {
        super(armorStandRender);
